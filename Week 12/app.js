...
function createShaders(loadedAssets) {
    ...
    loadShaderText('./shaders/flat.color.vs.glsl');
...
function updateAndRender() {
    ...
    var totalTransformation = translateBack.clone().multiply(rotation).multiply(translateToOrigin);
    
    orbGeometry.worldMatrix.multiply()
    lightPosition = totalTransformation.multiplyVector(light);
    time.update();
